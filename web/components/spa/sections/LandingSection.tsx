    ...
    <main id="main" className="landing">
      ...
      <section className="hero" aria-labelledby="hero-title">
        ...
        <div className="hero-actions">
          <Link href="/?p=atlas" className="btn-lg btn-primary">
            Explore the map →
          </Link>
          <Link href="/?p=methods" className="btn-ghost">
            How it&apos;s built
          </Link>
        </div>
      ...
      <section className="section" aria-labelledby="explore-title">
        ...
        <div className="feature-grid">
          <Link href="/?p=atlas&view=snapshot" className="feature">
          ...
          <Link href="/?p=atlas" className="feature">
            <span className="f-icon" aria-hidden="true">
              <MapIcon />
            </span>
          ...
          <Link href="/?p=methods" className="feature">
            <span className="f-icon" aria-hidden="true">
              <BookIcon />
            </span>
      ...
      <section className="section" aria-labelledby="measures-title">
        ...
        <div className="measure-chips">
          {catalog.metrics.map((m) => (
            <Link key={m.metric_id} href={`/?p=atlas&metric=${m.metric_id}`} className="chip-link">
      ...
      <section className="section" aria-labelledby="read-title">
        ...
        <div className="callout">
          ...
          <p style={{ margin: 0 }}>
            ...
            <Link href="/?p=methods">methods</Link> and <Link href="/?p=sources">sources</Link>.
          </p>
        </div>
      </section>
    </main>
